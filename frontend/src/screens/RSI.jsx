...
const RSITrading = () => {
    ...
    const handleMovingAverages = async() => {
        ...
        try {
            const response = await axios.get('http://localhost:5000/RSI-strategy', {
                params: {
            ...
            setErrorMessage('Failed to fetch RSI data');
        }
    }
    ...
    return (
        <div>
            <h1 className="page-title">RSI indicators Strategy</h1>
